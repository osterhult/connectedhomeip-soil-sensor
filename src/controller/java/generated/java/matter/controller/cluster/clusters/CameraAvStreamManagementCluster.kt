...
class CameraAvStreamManagementCluster(private val controller: MatterController, private val endpointId: UShort) {
  class AudioStreamAllocateResponse(
    val audioStreamID: UShort
  )

  class VideoStreamAllocateResponse(
    val videoStreamID: UShort
  )

  class SnapshotStreamAllocateResponse(
...
class FabricsUsingCameraAttribute(
  ...
  sealed class FabricsUsingCameraAttributeSubscriptionState {
    data class Success(
    val value: List<UByte>
    ) : FabricsUsingCameraAttributeSubscriptionState()
...
class AllocatedSnapshotStreamsAttribute(
  ...
  sealed class AllocatedSnapshotStreamsAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : AllocatedSnapshotStreamsAttributeSubscriptionState()

    object SubscriptionEstablished : AllocatedSnapshotStreamsAttributeSubscriptionState()    
  }  
class RankedVideoStreamPrioritiesListAttribute(
    val value: List<UByte>?
  )
  ...
  sealed class RankedVideoStreamPrioritiesListAttributeSubscriptionState {
    ...
    data class Error(val exception: Exception) : RankedVideoStreamPrioritiesListAttributeSubscriptionState()

    object SubscriptionEstablished : RankedVideoStreamPrioritiesListAttributeSubscriptionState()    
  }  
class ViewportAttribute(
    val value: CameraAvStreamManagementClusterViewportStruct?
  )
...
class AttributeListAttribute(
  ...
  suspend fun audioStreamAllocate(streamUsage: UByte
      ,audioCodec: UByte
      ,channelCount: UByte
      ,sampleRate: UInt
      ,bitRate: UInt
      ,bitDepth: UByte
      ,timedInvokeTimeout: Duration? = null): AudioStreamAllocateResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_AUDIO_STREAM_ID)) {audioStreamID_decoded = tlvReader.getUShort(tag)}  
  ...
  suspend fun audioStreamDeallocate(audioStreamID: UShort
  ...
  suspend fun videoStreamAllocate(streamUsage: UByte
      ,videoCodec: UByte
      ,minFrameRate: UShort
      ,maxFrameRate: UShort
      ...
      ,OSDEnabled: Boolean?
      ,timedInvokeTimeout: Duration? = null): VideoStreamAllocateResponse {
    ...
    OSDEnabled?.let {
      tlvWriter.put(ContextSpecificTag(TAG_OSD_ENABLED_REQ), OSDEnabled)
    }    
    tlvWriter.endStructure()
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_VIDEO_STREAM_ID)) {videoStreamID_decoded = tlvReader.getUShort(tag)}  
  ...
  suspend fun videoStreamModify(videoStreamID: UShort
      ,watermarkEnabled: Boolean?
      ,OSDEnabled: Boolean?
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun videoStreamDeallocate(videoStreamID: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun snapshotStreamAllocate(imageCodec: UByte
      ,maxFrameRate: UShort
      ,bitRate: UInt
      ,minResolution: CameraAvStreamManagementClusterVideoResolutionStruct
      ,maxResolution: CameraAvStreamManagementClusterVideoResolutionStruct
      ,quality: UByte
      ,timedInvokeTimeout: Duration? = null): SnapshotStreamAllocateResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_SNAPSHOT_STREAM_ID)) {snapshotStreamID_decoded = tlvReader.getUShort(tag)}  
    ...
    return SnapshotStreamAllocateResponse(
      snapshotStreamID_decoded
    )
  }

  suspend fun snapshotStreamDeallocate(snapshotStreamID: UShort
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun setStreamPriorities(streamPriorities: List<UByte>
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun captureSnapshot(snapshotStreamID: UShort
      ,requestedResolution: CameraAvStreamManagementClusterVideoResolutionStruct
      ,timedInvokeTimeout: Duration? = null): CaptureSnapshotResponse {
    ...
    while (!tlvReader.isEndOfContainer()) {
      ...
      if (tag == ContextSpecificTag(TAG_DATA)) {data_decoded = tlvReader.getByteArray(tag)}  
      
      if (tag == ContextSpecificTag(TAG_IMAGE_CODEC)) {imageCodec_decoded = tlvReader.getUByte(tag)}  
      
      if (tag == ContextSpecificTag(TAG_RESOLUTION)) {resolution_decoded = CameraAvStreamManagementClusterVideoResolutionStruct.fromTlv(tag, tlvReader)}  
...
suspend fun readMaxConcurrentVideoEncodersAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Maxconcurrentvideoencoders attribute not found in response" 
    }
...
suspend fun readMaxEncodedPixelRateAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Maxencodedpixelrate attribute not found in response" 
    }
...
suspend fun readVideoSensorParamsAttribute(): VideoSensorParamsAttribute {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Videosensorparams attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CameraAvStreamManagementClusterVideoSensorParamsStruct? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeVideoSensorParamsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(VideoSensorParamsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(VideoSensorParamsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readNightVisionCapableAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Nightvisioncapable attribute not found in response" 
    }
...
suspend fun readMinViewportAttribute(): MinViewportAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Minviewport attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CameraAvStreamManagementClusterVideoResolutionStruct? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeMinViewportAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(MinViewportAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Minviewport attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(MinViewportAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRateDistortionTradeOffPointsAttribute(): RateDistortionTradeOffPointsAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    requireNotNull(attributeData) { 
      "Ratedistortiontradeoffpoints attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterRateDistortionTradeOffPointsStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<CameraAvStreamManagementClusterRateDistortionTradeOffPointsStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(CameraAvStreamManagementClusterRateDistortionTradeOffPointsStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
    } else {
  ...
  suspend fun subscribeRateDistortionTradeOffPointsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RateDistortionTradeOffPointsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readMaxContentBufferSizeAttribute(): UInt? {val ATTRIBUTE_ID: UInt = 6u
    ...
    requireNotNull(attributeData) { 
      "Maxcontentbuffersize attribute not found in response" 
    }
...
suspend fun readMicrophoneCapabilitiesAttribute(): MicrophoneCapabilitiesAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    requireNotNull(attributeData) { 
      "Microphonecapabilities attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CameraAvStreamManagementClusterAudioCapabilitiesStruct? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeMicrophoneCapabilitiesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(MicrophoneCapabilitiesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(MicrophoneCapabilitiesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSpeakerCapabilitiesAttribute(): SpeakerCapabilitiesAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Speakercapabilities attribute not found in response" 
    }
  ...
  suspend fun subscribeSpeakerCapabilitiesAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SpeakerCapabilitiesAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SpeakerCapabilitiesAttributeSubscriptionState.Success(it))
          }
...
suspend fun readTwoWayTalkSupportAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 9u
    ...
    requireNotNull(attributeData) { 
      "Twowaytalksupport attribute not found in response" 
    }
...
suspend fun readSupportedSnapshotParamsAttribute(): SupportedSnapshotParamsAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    requireNotNull(attributeData) { 
      "Supportedsnapshotparams attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterSnapshotParamsStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
      buildList<CameraAvStreamManagementClusterSnapshotParamsStruct> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(CameraAvStreamManagementClusterSnapshotParamsStruct.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
    } else {
  ...
  suspend fun subscribeSupportedSnapshotParamsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SupportedSnapshotParamsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(SupportedSnapshotParamsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readMaxNetworkBandwidthAttribute(): UInt {val ATTRIBUTE_ID: UInt = 11u
    ...
    requireNotNull(attributeData) { 
      "Maxnetworkbandwidth attribute not found in response" 
    }
...
suspend fun readCurrentFrameRateAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 12u
    ...
    requireNotNull(attributeData) { 
      "Currentframerate attribute not found in response" 
    }
...
suspend fun readHDRModeEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 13u
    ...
    requireNotNull(attributeData) { 
      "Hdrmodeenabled attribute not found in response" 
    }
  ...
  suspend fun writeHDRModeEnabledAttribute(
    value: Boolean,
...
suspend fun readFabricsUsingCameraAttribute(): FabricsUsingCameraAttribute {val ATTRIBUTE_ID: UInt = 14u
    ...
    requireNotNull(attributeData) { 
      "Fabricsusingcamera attribute not found in response" 
    }
  ...
  suspend fun subscribeFabricsUsingCameraAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(FabricsUsingCameraAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readAllocatedVideoStreamsAttribute(): AllocatedVideoStreamsAttribute {val ATTRIBUTE_ID: UInt = 15u
    ...
    requireNotNull(attributeData) { 
      "Allocatedvideostreams attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterVideoStreamStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeAllocatedVideoStreamsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AllocatedVideoStreamsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AllocatedVideoStreamsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAllocatedAudioStreamsAttribute(): AllocatedAudioStreamsAttribute {val ATTRIBUTE_ID: UInt = 16u
    ...
    requireNotNull(attributeData) { 
      "Allocatedaudiostreams attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterAudioStreamStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeAllocatedAudioStreamsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AllocatedAudioStreamsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AllocatedAudioStreamsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readAllocatedSnapshotStreamsAttribute(): AllocatedSnapshotStreamsAttribute {val ATTRIBUTE_ID: UInt = 17u
    ...
    requireNotNull(attributeData) { 
      "Allocatedsnapshotstreams attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<CameraAvStreamManagementClusterSnapshotStreamStruct>? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeAllocatedSnapshotStreamsAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(AllocatedSnapshotStreamsAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
      ...
      null
          ...
          decodedValue?.let {
            emit(AllocatedSnapshotStreamsAttributeSubscriptionState.Success(it))
          }
...
suspend fun readRankedVideoStreamPrioritiesListAttribute(): RankedVideoStreamPrioritiesListAttribute {val ATTRIBUTE_ID: UInt = 18u
  ...
  suspend fun subscribeRankedVideoStreamPrioritiesListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(RankedVideoStreamPrioritiesListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
...
suspend fun readSoftRecordingPrivacyModeEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 19u
...
suspend fun readSoftLivestreamPrivacyModeEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 20u
...
suspend fun readHardPrivacyModeOnAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 21u
    ...
    requireNotNull(attributeData) { 
      "Hardprivacymodeon attribute not found in response" 
    }
...
suspend fun readNightVisionAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 22u
    ...
    requireNotNull(attributeData) { 
      "Nightvision attribute not found in response" 
    }
  ...
  suspend fun writeNightVisionAttribute(
    value: UByte,
    timedWriteTimeout: Duration? = null) {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Nightvision attribute not found in Node State update" 
          }
...
suspend fun readNightVisionIllumAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 23u
    ...
    requireNotNull(attributeData) { 
      "Nightvisionillum attribute not found in response" 
    }
  ...
  suspend fun writeNightVisionIllumAttribute(
    value: UByte,
    timedWriteTimeout: Duration? = null) {
...
suspend fun readViewportAttribute(): ViewportAttribute {val ATTRIBUTE_ID: UInt = 24u
    ...
    requireNotNull(attributeData) { 
      "Viewport attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: CameraAvStreamManagementClusterViewportStruct? = if (tlvReader.isNextTag(AnonymousTag)) {
  ...
  suspend fun subscribeViewportAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(ViewportAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Viewport attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(ViewportAttributeSubscriptionState.Success(it))
          }
...
suspend fun readSpeakerMutedAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 25u
    ...
    requireNotNull(attributeData) { 
      "Speakermuted attribute not found in response" 
    }
  ...
  suspend fun writeSpeakerMutedAttribute(
    value: Boolean,
    timedWriteTimeout: Duration? = null) {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Speakermuted attribute not found in Node State update" 
          }
...
suspend fun readSpeakerVolumeLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 26u
    ...
    requireNotNull(attributeData) { 
      "Speakervolumelevel attribute not found in response" 
    }
  ...
  suspend fun writeSpeakerVolumeLevelAttribute(
    value: UByte,
    timedWriteTimeout: Duration? = null) {
...
suspend fun readSpeakerMaxLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 27u
    ...
    requireNotNull(attributeData) { 
      "Speakermaxlevel attribute not found in response" 
    }
...
suspend fun readSpeakerMinLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 28u
    ...
    requireNotNull(attributeData) { 
      "Speakerminlevel attribute not found in response" 
    }
...
suspend fun readMicrophoneMutedAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 29u
    ...
    requireNotNull(attributeData) { 
      "Microphonemuted attribute not found in response" 
    }
  ...
  suspend fun writeMicrophoneMutedAttribute(
    value: Boolean,
    timedWriteTimeout: Duration? = null) {
...
suspend fun readMicrophoneVolumeLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 30u
    ...
    requireNotNull(attributeData) { 
      "Microphonevolumelevel attribute not found in response" 
    }
...
suspend fun readMicrophoneMaxLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 31u
    ...
    requireNotNull(attributeData) { 
      "Microphonemaxlevel attribute not found in response" 
    }
...
suspend fun readMicrophoneMinLevelAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 32u
    ...
    requireNotNull(attributeData) { 
      "Microphoneminlevel attribute not found in response" 
    }
...
suspend fun readMicrophoneAGCEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 33u
    ...
    requireNotNull(attributeData) { 
      "Microphoneagcenabled attribute not found in response" 
    }
...
suspend fun readImageRotationAttribute(): UShort? {val ATTRIBUTE_ID: UInt = 34u
    ...
    requireNotNull(attributeData) { 
      "Imagerotation attribute not found in response" 
    }
  ...
  suspend fun writeImageRotationAttribute(
    value: UShort,
    timedWriteTimeout: Duration? = null) {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Imagerotation attribute not found in Node State update" 
          }
...
suspend fun readImageFlipHorizontalAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 35u
    ...
    requireNotNull(attributeData) { 
      "Imagefliphorizontal attribute not found in response" 
    }
...
suspend fun readImageFlipVerticalAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 36u
    ...
    requireNotNull(attributeData) { 
      "Imageflipvertical attribute not found in response" 
    }
  ...
  suspend fun writeImageFlipVerticalAttribute(
    value: Boolean,
    timedWriteTimeout: Duration? = null) {
...
suspend fun readLocalVideoRecordingEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 37u
    ...
    requireNotNull(attributeData) { 
      "Localvideorecordingenabled attribute not found in response" 
    }
...
suspend fun readLocalSnapshotRecordingEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 38u
...
suspend fun readStatusLightEnabledAttribute(): Boolean? {val ATTRIBUTE_ID: UInt = 39u
    ...
    requireNotNull(attributeData) { 
      "Statuslightenabled attribute not found in response" 
    }
...
suspend fun readStatusLightBrightnessAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 40u
    ...
    requireNotNull(attributeData) { 
      "Statuslightbrightness attribute not found in response" 
    }
