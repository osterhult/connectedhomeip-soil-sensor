...
class SoilMeasurementCluster(private val controller: MatterController, private val endpointId: UShort) {class SoilMoistureMeasuredValueAttribute(
    val value: UByte?
  )

  sealed class SoilMoistureMeasuredValueAttributeSubscriptionState {
    data class Success(
    val value: UByte?
    ) : SoilMoistureMeasuredValueAttributeSubscriptionState()
    
    data class Error(val exception: Exception) : SoilMoistureMeasuredValueAttributeSubscriptionState()

    object SubscriptionEstablished : SoilMoistureMeasuredValueAttributeSubscriptionState()    
  }  
...
suspend fun readSoilMoistureMeasuredValueAttribute(): SoilMoistureMeasuredValueAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    requireNotNull(attributeData) { 
      "Soilmoisturemeasuredvalue attribute not found in response" 
    }
    ...
    return SoilMoistureMeasuredValueAttribute(decodedValue)
  }

  suspend fun subscribeSoilMoistureMeasuredValueAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<SoilMoistureMeasuredValueAttributeSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(SoilMoistureMeasuredValueAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Soilmoisturemeasuredvalue attribute not found in Node State update" 
          }
      ...
      null
          ...
          decodedValue?.let {
            emit(SoilMoistureMeasuredValueAttributeSubscriptionState.Success(it))
          }
          
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(SoilMoistureMeasuredValueAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }    
  }
suspend fun readSoilMoistureMinMeasurableValueAttribute(): UByte {val ATTRIBUTE_ID: UInt = 1u
    ...
    requireNotNull(attributeData) { 
      "Soilmoistureminmeasurablevalue attribute not found in response" 
    }
  ...
  suspend fun subscribeSoilMoistureMinMeasurableValueAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Soilmoistureminmeasurablevalue attribute not found in Node State update" 
          }
...
suspend fun readSoilMoistureMaxMeasurableValueAttribute(): UByte {val ATTRIBUTE_ID: UInt = 2u
    ...
    requireNotNull(attributeData) { 
      "Soilmoisturemaxmeasurablevalue attribute not found in response" 
    }
  ...
  suspend fun subscribeSoilMoistureMaxMeasurableValueAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<UByteSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Soilmoisturemaxmeasurablevalue attribute not found in Node State update" 
          }
...
suspend fun readSoilMoistureToleranceAttribute(): UByte? {val ATTRIBUTE_ID: UInt = 3u
    ...
    requireNotNull(attributeData) { 
      "Soilmoisturetolerance attribute not found in response" 
    }
  ...
  suspend fun subscribeSoilMoistureToleranceAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<UByteSubscriptionState> {
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { 
            "Soilmoisturetolerance attribute not found in Node State update" 
          }
...
suspend fun readClusterRevisionAttribute(): UShort {val ATTRIBUTE_ID: UInt = 65533u
  ...
  companion object {
    private val logger = Logger.getLogger(SoilMeasurementCluster::class.java.name)
    const val CLUSTER_ID: UInt = 1072u
  }
}
