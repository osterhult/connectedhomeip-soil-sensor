...
class WebRTCTransportRequestorCluster(private val controller: MatterController, private val endpointId: UShort) {class CurrentSessionsAttribute(
...
class AttributeListAttribute(
  ...
  suspend fun offer(webRTCSessionID: UShort
      ,sdp: String
  ...
  suspend fun answer(webRTCSessionID: UShort
      ,sdp: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun ICECandidate(webRTCSessionID: UShort
      ,ICECandidate: String
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun end(webRTCSessionID: UShort
      ,reason: UByte
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readCurrentSessionsAttribute(): CurrentSessionsAttribute {val ATTRIBUTE_ID: UInt = 0u
    ...
    val decodedValue: List<WebRTCTransportRequestorClusterWebRTCSessionStruct> = buildList<WebRTCTransportRequestorClusterWebRTCSessionStruct> {
